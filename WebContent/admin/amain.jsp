...
String noticeSearchWord = (String)request.getAttribute("noticeSearchWord");
String accessSearchWord = (String)request.getAttribute("accessSearchWord");
String exhibitSearchWord = (String)request.getAttribute("exhibitSearchWord");

String noticeSearchChoice = (String)request.getAttribute("noticeSearchChoice");
String accessSearchChoice = (String)request.getAttribute("accessSearchChoice");
String exhibitSearchChoice = (String)request.getAttribute("exhibitSearchChoice");
...
$("#noticeSearchWord").val("<%=noticeSearchWord%>");
$("#accessSearchWord").val("<%=accessSearchWord%>");
$("#exhibitSearchWord").val("<%=exhibitSearchWord%>");

$("#noticeSearchChoice").val("<%=noticeSearchChoice%>");
$("#accessSearchChoice").val("<%=accessSearchChoice%>");
$("#exhibitSearchChoice").val("<%=exhibitSearchChoice%>");
</script>
