			...
			<div class="tabcontWrap">
				...
				<div class="tab_con" id="admin02">
					...
					<div class="admin-btn">
						...
						<input type="button" name="exhibitWrite" value="전시등록"
							onclick="location.href='../admin/noticeWrite.jsp'"> <input
							type="button" name="btn_exhibitDelete" id="btn_exhibitDelete"
							value="전시삭제">
					</div>					
					<table class="admintbl">
						<col width="70">
